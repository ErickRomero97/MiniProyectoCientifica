...
Public Class FrmPrincipal
    ...
    Private Sub SolicitudPrestamoToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SolicitudPrestamoToolStripMenuItem.Click
        ...
        FrmSolicitudPrestamo.MdiParent = Me
        FrmSolicitudPrestamo.Show()
        PBLogoPequeño.BringToFront()
        PBLogoGrande.SendToBack()
        PnlFondo.SendToBack()
        FrmSolicitudPrestamo.Location = New Point(350, 0)
    ...
    Private Sub ToolStripStatusLabel2_Click(sender As Object, e As EventArgs) Handles LblIdUsuario.Click
    ...
    Private Sub LogAuditoriaToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LogAuditoriaToolStripMenuItem.Click
        Dim MILogAudi As New FrmLogAuditoria()
        MILogAudi.MdiParent = Me
        MILogAudi.Show()
        PBLogoPequeño.BringToFront()
        PBLogoGrande.SendToBack()
        PnlFondo.SendToBack()
        MILogAudi.Location = New Point(550, 60)
    End Sub
End Class
